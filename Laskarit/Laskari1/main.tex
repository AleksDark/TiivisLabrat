...
\chead[C]{\Large AOL 1-2, tiiviskurssi, laskari 1}
\title{AOL laskarit I}
\begin{document}
...
\section*{Tehtävä 1}
\subsection*{1. a)}
Jännitelähteen ja sähkömittarin sisäisten vastusten resistanssi ovat liian pienet mahdollistakseen jännitehäviön, joten piiri ovat oikosulussa. 

\textbf{Korjaus:} Vastus tarvitaan.

\subsection*{1. b)}
Oskilloskooppi on hieman kuten jännitelähde, ja niiden molempien sisäiset vastukset ovat niin suuret, ettei niistä pääse kulkemaan sähkövirta.

\textbf{Korjaus:} Oskilloskooppi pitäisi kytkea rinnakkain ei sarjaan.

\subsection*{1. c)}
Tutkittaessa vastusta yleismittari luo jännite-eron paikallisesti, jolloin ulkoinen virtalähde aiheuttaa häiriötä/muuttaa tuloksia.

\textbf{Korjaus:} Avata piirin tai poistaa jännitelähteen.

\subsection*{1. d)} 
Alempi vastus on molemmista päistä maadoitettu, joten tutkiminen ei ole mahdollista.
...
\begin{figure}[!hbt]
\includegraphics[width=0.95\textwidth]{Laskari13}
\end{figure}
